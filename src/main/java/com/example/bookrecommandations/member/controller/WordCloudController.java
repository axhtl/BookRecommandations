...
public class WordCloudController {
    ...
    @PostMapping("/words/{reviewId}")
    public List<Map<String, Object>> getWordCloudKeywords(@PathVariable Long reviewId) {
        // generateWordCloud에서 문자열 형태의 파이썬 출력 결과를 받아옴
        String keywordsString = wordCloudService.generateWordCloud(reviewId);
