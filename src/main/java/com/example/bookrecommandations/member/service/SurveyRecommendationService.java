...
public class SurveyRecommendationService {
    ...
    public SurveyRecommendationService(MemberRepository memberRepository, PreferredGenreRepository preferredGenreRepository, SurveyRepository surveyRepository) {
